...
const AlgoSort = () => {
  return (
    <div className="m-auto max-w-screen-2xl w-full min-h-screen h-fit py-6 md:py-8">
      ...
      <div className="pt-6 animate-appear md:pt-8">
        ...
        <div className="px-4 mb-10 md:px-12 lg:px-28 xl:px-44">
          ...
          <p className="text-white text-sm text-justify md:text-base">
            ...
            flower pots by the following method- He looks at the flower pot next
            to him and the previous one; if they are in the right order he steps
            one pot forward, otherwise he swaps them and steps one pot
            backwards. If there is no previous pot (he is at the starting of the
            pot line), he steps forwards; if there is no pot next to him (he is
            at the end of the pot line), he is done.
          </p>
        </div>
        <div className="px-4 mb-10 md:px-12 lg:px-28 xl:px-44">
          <p className="text-white text-xl underline mb-2 md:text-2xl">
          ...
          <p className="text-white text-sm text-justify md:text-base">
            ...
            part are picked and placed in the correct position in the sorted
            part.
          </p>
        </div>
      </div>
